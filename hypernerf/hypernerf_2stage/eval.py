...
def compute_stats(batch, model_out):
  ...
  if 'rgb' in batch:
    ...
    image_utils.save_image("/Users/weijia/hypernerf_1stage/human_0730/gt.png",
                           image_utils.image_to_uint8(rgb_target))
    input()
    ...
    stats['lpips_alex'] = lpips_alex
    stats['lpips_vgg'] = lpips_vgg
