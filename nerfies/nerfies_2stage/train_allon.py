...
def main(argv):
    ...
    for step, batch in zip(range(init_step, train_config.max_steps + 1),
        ...
        # print(step)
        # directions = np.array(batch['directions'])
        # print(directions.shape)
        # print(batch['rgb'])
        # rgb = np.array(batch['rgb'])
        # print(rgb.shape)
        # print(np.sum(rgb))
    ...
    # print("print target")
    # print(state.optimizer.target)
    # print("print target")
    # input()
    # nerf_params_fine = state.optimizer.target['model']['nerf_mlps_fine']
    # nerf_params_coarse = state.optimizer.target['model']['nerf_mlps_coarse']
    ...
    for step, batch in zip(range(init_step, train_config.max_steps * 2 + 1),
                           train_iter):
        ...
        # print(rgb.shape)
        # print(np.sum(rgb))
        # state.optimizer.target['model']['nerf_mlps_fine'] = nerf_params_fine
        # state.optimizer.target['model']['nerf_mlps_coarse'] = nerf_params_coarse
        ...
        if step % train_config.print_every == 0 and jax.process_index() == 0:
            ...
            # #       print(value)
            # input()
            # print(state.optimizer.target['model']['warp_field']['metadata_encoder']['embed']['embedding'])
            # input()
